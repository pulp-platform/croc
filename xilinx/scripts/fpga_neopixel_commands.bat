...
@REM set *0x20001060=4
@REM set *0x20001080=16
@REM set *0x200010a0=9
@REM set *0x200010c0=8
@REM set *0x200010e0=17
@REM set *0x20001100=1000
@REM set *0x20001100=10000000

set *0x20001180=1
set *0x20001200=0x00ff0000

set *0x10000374=0x00ff00
set *0x10000378=0xff0000
set *0x1000037c=0x0000ff
set *0x10000380=0x1ff00
set *0x10000384=0x0000fff
set *0x10000388=0x0000f00
set *0x1000038c=0x0000011
set *0x10000390=0x00f0fff
set *0x10000394=0x0000f00
set *0x10000398=0x0000000
set *0x1000039c=0x0000000
set *0x100003a0=0x0000000
set *0x100003a4=0x0000000
set *0x100003a8=0x0000000
set *0x100003ac=0x0000000
set *0x100003b0=0x0000000
set *0x100003b4=0x0000000
set *0x100003b8=0x0000000
set *0x100003bc=0x0000000
set *0x100003c0=0x0000000
set *0x100003c4=0x0000000
set *0x100003c8=0x0000000
set *0x100003cc=0x0000000
set *0x100003d0=0x0000000
set *0x100003d4=0x0000000
set *0x100003d8=0x0000000
set *0x100003dc=0x0000000
set *0x100003e0=0x0000000
set *0x100003e4=0x0000fff
