...
declare -A step_to_tcl=(
    [floorplan]="00_floorplan.tcl"
    [placement]="01_placement.tcl"
    [cts]="02_cts.tcl"
    [routing]="03_routing.tcl"
    [finishing]="04_finishing.tcl"
)

declare -A step_to_input_checkpoint=(
    [floorplan]=""  # No input checkpoint (reads netlist directly)
    [placement]="00_${PROJ_NAME}.floorplan"
    [cts]="03_${PROJ_NAME}.dpl"
    [cts]="04_${PROJ_NAME}.cts"
    [routing]="04_${PROJ_NAME}.cts"
    [finishing]="06_${PROJ_NAME}.drt"
)
