...
# === Variant Configuration (to be set before sourcing) ===
# Example:
# set variant_name sparse
# set stripe_width 1.0
# set stripe_pitch 100.0
# set add_ring 1
# set add_vertical 1
...
if { ![info exists sram_extra_power] }    { set sram_extra_power 1 }
...
set tpg2Width    $stripe_width; # arbitrary number
set tpg2Pitch    $stripe_pitch; # multiple of pad-pitch
