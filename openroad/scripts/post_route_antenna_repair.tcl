...
## Post-Route Antenna Repair Script
...
for {set iteration 1} {$iteration <= $max_iterations} {incr iteration} {
    ...
    set report_file_name "04_${proj_name}_post_route_antenna_$iteration.rpt"
    ...
    puts "Detailed route"
    detailed_route -output_drc "${report_dir}/04_${proj_name}_post_route_antenna_fix_drc_${iteration}.rpt" \
