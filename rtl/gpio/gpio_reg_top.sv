...
module gpio_reg_top #(
    ...
    logic                        err;
    logic [BlockAw-1:0]          word_addr_d, word_addr_q; //is delayed for the response phase
    ...
    always_comb begin
      ...
      if (obi_req_i.req & obi_req_i.a.we) begin
        ...
        case (word_addr_q)
          GPIO_DIR_OFFSET: begin
            reg_d.str.in = (~be_mask & reg_q.str.in) | (be_mask & obi_req_i.a.wdata[GpioCount-1:0]);
          end

          GPIO_EN_OFFSET: begin
            reg_d.str.en = (~be_mask & reg_q.str.en) | (be_mask & obi_req_i.a.wdata[GpioCount-1:0]);
          end
      ...
      if (obi_req_i.req & ~obi_req_i.a.we) begin
        ...
        reg2hw.gpio_toggle_r =
          (~reg2hw.gpio_toggle_r_allw & reg2hw.gpio_toggle_r) |
          (reg2hw.gpio_toggle_r_allw & reg_q.str.toggle);
